...
-- Disable displaying mode as it can already be seen in the status line
...
-- Set the softtabstop to 4 characters
vim.opt.softtabstop = 4

-- Set expandtab to true, which will convert tabs to spaces
